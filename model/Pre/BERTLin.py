...
# Paper: Linrec: Linear attention mechanism for long-term sequential recommender systems
...
class BERTLin(SequentialRecommender):
    def __init__(self, conf, training_set, test_set):
        ...
        self.model = LinRec_Model_bert(self.data, self.emb_size, self.max_len, block_num,head_num,drop_rate,self.feature,datasetFile,self.strategy)
